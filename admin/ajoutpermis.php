...
<ul id="css3menu1" class="topmenu">
  ...
  <li><a class="active" href="./permis.php">Nos Permis</a></li>
  <li><a href="./code.php">Code De La Route</a></li>
</ul>

<div id="div01">
<form action="./sql/ajoutpermis_sql.php" method="POST" enctype="multipart/form-data">

	<div id="div0">
	<center><h3 id="h3"> Ajouter un livre </h3></center><br/><br/>
  <label>Url :</label> <input type="file" name="file"><br/><br/>
  <label>Type :</label> <input type="text" name="2"   required><br/>
  ...
  <a href="./permis.php"><button type="button" class="button4">Retour</button></a>
  </center>
  <br/><br/>
</form>
</div>
