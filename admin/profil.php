...
<body>
<form name="f" method="POST" action="./modif_profil.php">
<div id="div1">
<div id="div2">
<center>
...
<div id="div01">
 ...
 <ul id="css3menu2" class="topmenu">
  ...
  <div id="div0">
  <label>Nom D'utilisateur :</label> <font class="txt04" ><b><?php echo $_SESSION['username'] ?></b></font><br/>
  <hr style="width: 34%;margin-left: -1%;"></hr>
  <label>Nom et Pr&eacute;nom :</label> <font class="txt04" ><b><?php echo $_SESSION['name'] ?></b></font><br/>
  <hr style="width: 34%;margin-left: -1%;"></hr>
  <label>Date de Naissance :</label> <font class="txt04" ><b><?php echo $_SESSION['dob'] ?></b></font><br/>
  <hr style="width: 34%;margin-left: -1%;"></hr>
  <label>Region :</label> <font class="txt04" ><b><?php echo $_SESSION['region'] ?></b></font><br/>
  <hr style="width: 34%;margin-left: -1%;"></hr>
  <label>Email :</label> <font class="txt04" ><b><?php echo $_SESSION['email'] ?></b></font><br/>
  <hr style="width: 34%;margin-left: -1%;"></hr>
  <label>Num&eacute;ro :</label> <font class="txt04" ><b><?php echo $_SESSION['phone'] ?></b></font><br/>
  <hr style="width: 34%;margin-left: -1%;"></hr>
  </div>
  <br/><br/>
  <center>
