...
<body>
<form name="ff" method="POST" action="./sql/ajoutcode_sql.php">
<div id="div1">
<div id="div2">
<center>
...
<ul id="css3menu1" class="topmenu">
  ...
  <li><a  href="./permis.php">Nos Permis</a></li>
...
<div id="div01">
	...
	<div id="div0">
	<center><h3 id="h3"> Ajouter un livre </h3></center>
  <label>Url :</label> <input type="text" name="1" ><br/>
  <label>Gratuit / Payant :</label> <input type="text" name="2" required title=""><br/>
  <label>Prix :</label> <input type="text" name="3" required title="prix"><br/>
  <label>paye :</label> <input type="text" name="4"required title="paye" ><br/>
