...
<div id="div01">
 ...
 <ul id="css3menu2" class="topmenu">
	...
	<li><a class="active" href="./moniteur.php">Moniteurs</a></li>
...
<div id="popup">
	...
	<div id="div0">
  <label>Nom D'utilisateur :</label> <font class="txt04" ><b><?php echo $_SESSION['mont1']; ?></b></font><br/>
  <hr style="width: 34%;margin-left: -1%;"></hr>
  <label>Nom et Pr&eacute;nom :</label> <font class="txt04" ><b><?php echo $_SESSION['mont2']; ?></b></font><br/>
  <hr style="width: 34%;margin-left: -1%;"></hr>
  <label>Date de Naissance :</label> <font class="txt04" ><b><?php echo $_SESSION['mont3']; ?></b></font><br/>
  <hr style="width: 34%;margin-left: -1%;"></hr>
  <label>Region :</label> <font class="txt04" ><b><?php echo $_SESSION['mont4']; ?></b></font><br/>
  <hr style="width: 34%;margin-left: -1%;"></hr>
  <label>Email :</label> <font class="txt04" ><b><?php echo $_SESSION['mont5']; ?></b></font><br/>
  <hr style="width: 34%;margin-left: -1%;"></hr>
  <label>Num&eacute;ro :</label> <font class="txt04" ><b><?php echo $_SESSION['mont6']; ?></b></font><br/>
  <hr style="width: 34%;margin-left: -1%;"></hr>
  <label>Genre :</label> <font class="txt04" ><b><?php echo $_SESSION['mont7']; ?></b></font><br/>
  <hr style="width: 34%;margin-left: -1%;"></hr>
		...
		<br/>
		<center>
  <a href="./modifmont.php"><button class="button">Modifier</button></a>
  <a href="sql/montdel_sql.php?<?php echo $_SESSION['mont1']; ?>" ><button class="button2">Supprimer</button></a>
  <a href="./moniteur.php"><button class="button4">Retour</button></a>
  </center>
</table>
  <br/><br/>
