...
<form name="f" method="POST" action="sql/mdp_sql.php" onsubmit="return  validateForm()">
<div id="div1">
<div id="div2">
<center>
...
<div id="div01">
 ...
 <ul id="css3menu2" class="topmenu">
	...
	<li><a class="active" href="./passe.php">Mot de Passe</a></li>
...
<div id="popup2">
  ...
  <div id="div0">
 <center> <h3 id="h3"> Changer Votre Mot De Passe</h3></center>
  <label>Nouveau Mot De Passe :</label> <input type="password" name="1"  ><br/>
  <label>Confirmer Mot De Passe :</label> <input type="password" name="2"  ><br/>
  ...
  <button class="button">Confirmer</button>
   ...
   <button type="reset" class="button2">Annuler</button>
	</form>
  </center>
</div>
