...
include "sql/modifypermis_sql.php";
...
<div id="div01">
<form name="ff" method="POST" action="./sql/modifpermis_sql.php" enctype="multipart/form-data">
	<div id="div0"><br/>
  <label>Url :</label>  <input type="file" name="file"><br/>
  <label>Type :</label> <input type="text" name="2" value="<?php echo $_SESSION['tt']; ?>"><br/>
